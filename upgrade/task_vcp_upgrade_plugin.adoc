...
+
image::vcp_remote_plugin_icons_home_page.png[La illustre les points d'extension du plug-in après une mise à niveau ou une installation réussie pour le plug-in Element 5.10 ou version ultérieure]

+
Plug-in Element pour vCenter Server 4.10 ou version antérieure, points d'extension NetApp Element Configuration and Management :
